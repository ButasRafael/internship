...
import {pwdResetRouter} from "./auth.passwordReset.routes.js";
import {emailVerifyRouter} from "./auth.emailVerify.routes.js";

export const authRouter = Router();
authRouter.use('/password-reset', pwdResetRouter);
authRouter.use('/email-verification', emailVerifyRouter);
/**
 * @openapi
 * tags:
 *   - name: Auth
